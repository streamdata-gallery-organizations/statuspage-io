...
paths:
  ...
  /pages/[page_id]/page_access_users/[page_access_user_id].json:
    patch:
      ...
      x-api-path-slug: pagespage-idpage-access-userspage-access-user-idjson-patch
      parameters:
      - in: query
        name: page_access_user[component_ids][]
        description: Array of component ids that the created user will ba able to
    ...
    delete:
      ...
      x-api-path-slug: pagespage-idpage-access-userspage-access-user-idjson-delete
      responses:
        200:
          description: OK
      tags:
  ...
  /pages/[page_id]/page_access_users/[page_access_user_id]/components.json:
    post:
      ...
      x-api-path-slug: pagespage-idpage-access-userspage-access-user-idcomponentsjson-post
      parameters:
      - in: query
        name: component_ids[]
    ...
    patch:
      ...
      x-api-path-slug: pagespage-idpage-access-userspage-access-user-idcomponentsjson-patch
      parameters:
      - in: query
        name: component_ids[]
        description: Array of component ids that the user will ba able to view
    ...
    delete:
      ...
      x-api-path-slug: pagespage-idpage-access-userspage-access-user-idcomponentsjson-delete
      responses:
        200:
          description: OK
      tags:
  ...
  /pages/[page_id]/components/[component_id]/page_access_users.json:
    post:
      ...
      x-api-path-slug: pagespage-idcomponentscomponent-idpage-access-usersjson-post
      parameters:
      - in: query
    ...
    delete:
      ...
      x-api-path-slug: pagespage-idcomponentscomponent-idpage-access-usersjson-delete
      responses:
        200:
          description: OK
      tags:
  ...
  /pages/[page_id]/page_access_groups.json:
    get:
      ...
      x-api-path-slug: pagespage-idpage-access-groupsjson-get
      responses:
        200:
          description: OK
      tags:
    ...
    post:
      ...
      x-api-path-slug: pagespage-idpage-access-groupsjson-post
      parameters:
      - in: query
  ...
  /pages/[page_id]/page_access_groups/[page_access_group_id].json:
    patch:
      ...
      x-api-path-slug: pagespage-idpage-access-groupspage-access-group-idjson-patch
      parameters:
      - in: query
        name: page_access_group[component_ids][]
        description: Array of component ids that the created group will be able to
    ...
    delete:
      ...
      x-api-path-slug: pagespage-idpage-access-groupspage-access-group-idjson-delete
      parameters:
      - in: query
  ...
  /pages/[page_id]/page_access_groups/[page_access_group_id]/components.json:
    post:
      ...
      x-api-path-slug: pagespage-idpage-access-groupspage-access-group-idcomponentsjson-post
      parameters:
      - in: query
        name: component_ids[]
    ...
    patch:
      ...
      x-api-path-slug: pagespage-idpage-access-groupspage-access-group-idcomponentsjson-patch
      parameters:
      - in: query
        name: component_ids[]
        description: Array of component ids that the group will ba able to view
    ...
    delete:
      ...
      x-api-path-slug: pagespage-idpage-access-groupspage-access-group-idcomponentsjson-delete
      responses:
        200:
          description: OK
      tags:
  ...
  /pages/[page_id]/components/[component_id]/page_access_groups.json:
    post:
      ...
      x-api-path-slug: pagespage-idcomponentscomponent-idpage-access-groupsjson-post
      parameters:
      - in: query
    ...
    delete:
      ...
      x-api-path-slug: pagespage-idcomponentscomponent-idpage-access-groupsjson-delete
      responses:
        200:
          description: OK
      tags:
